...
/**
 * Advisory for browsers and any shared cache in front of us. It does *not*
 * populate Cloudflare's edge cache — a Worker response isn't stored there — so
 * it protects nothing upstream. Golemio is protected by the edge-cached
 * subrequest in `getVehiclePositions`; keep the 30 s here in step with it.
 */
