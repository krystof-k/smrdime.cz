  ...
  return (
    <div className="px-4 text-left md:px-8 lg:px-12">
      <h1 className="text-5xl text-gray-800 leading-tight md:text-6xl lg:text-7xl dark:text-gray-100">
        ...
        <span className="font-thin">kolik tramvají jede bez klimatizace</span>.
      </h1>
      <p className="mt-8 font-light text-gray-600 text-xl leading-relaxed md:text-2xl dark:text-gray-300">
        Server si asi dal <span className="font-black">pauzu</span>, nebo se tramvaje{" "}
        <span className="font-black">zakecaly</span> někde v depu. Zkus to za chvíli{" "}
        <button
          type="button"
          onClick={onRetry}
